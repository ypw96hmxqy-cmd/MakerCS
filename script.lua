...
makeButton(mainContent, "Toggle Invisible", 250, toggleInvisible, {invisible})
...
makeButton(scriptsContent, "Load Pastefy Script", 190, function()
...
makeButton(scriptsContent, "Load Emotes Script", 250, function()
...
notify("MakerCS Loaded! 5 scripts in Scripts tab + Invisibility added!")